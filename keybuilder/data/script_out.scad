...
dimple_laser_dxf_name = "";
dimple_laser_stl_name = "";
...
lever_lock_row1_angle_on_y = 			[0,0,0];
...
lever_lock_row2_angle_on_y = [0,0,0];
...
abloy_disklock_groove_at_the_tip = 0;
...
//AXI HOME PARAMETERS
//CONSTANTS
axi_home_interpin_distance =        3 ;
axi_home_top_row_x_offset =         3 ;
axi_home_row1_shoulder_distance =   23.8-19.5 ;//CLOSEST TO BOW
axi_home_row2_shoulder_distance =   23.8-19 ;
axi_home_row3_shoulder_distance =   23.8-18.5 ; //CLOSEST TO TIP
axi_home_root_x =                   1 ; 
axi_home_root_y =                   1 ; 
...
extra_material_shape_01_stl_name = "";
...
extra_material_shape_02_stl_name = "";
...
extra_material_shape_03_stl_name = "";
...
extra_material_shape_04_stl_name = "";
...
extra_material_shape_05_stl_name = "";
...
extra_material_shape_06_stl_name = "";
...
extra_material_shape_07_stl_name = "";
...
extra_material_shape_08_stl_name = "";
...
extra_material_shape_09_stl_name = "";
...
extra_material_shape_10_stl_name = "";
...
//END OF MODULE REGULAR


module dimple_laser(dimple_laser_length=dimple_laser_length, 
                    dimple_laser_width=dimple_laser_width, 
                    dimple_laser_thickness=dimple_laser_thickness, 
                    dimple_laser_dxf_name=dimple_laser_dxf_name, 
                    dimple_laser_stl_name=dimple_laser_stl_name)
{
    color ("red") 
    {
        if (dimple_laser_dxf_name=="0")
        {
            resize([dimple_laser_width,dimple_laser_length+1,dimple_laser_thickness])   import(dimple_laser_stl_name);
        }//END OF IF
        
        else
        {            
            translate ([0,dimple_laser_length,0])
            rotate([90,0,0])
            resize([dimple_laser_width,dimple_laser_thickness,dimple_laser_length+1])
            linear_extrude(height = dimple_laser_length+1, center = 1, convexity = 10)
            import (file = dimple_laser_dxf_name); 
        }//END OF ELSE
    }//END OF COLOR
}
//END OF MODULE DIMPLE LASER

module round_pump(round_pump_length=round_pump_length,
                  round_pump_diameter=round_pump_diameter,
                  round_pump_number_of_raised_wings=round_pump_number_of_raised_wings,
                  round_pump_raised_diameter=round_pump_raised_diameter,
                  round_pump_raised_length_from_tip=round_pump_raised_length_from_tip,
                  round_pump_raised_thickness=round_pump_raised_thickness,
                  ...
                  round_pump_inward_tensioner_thickness=round_pump_inward_tensioner_thickness)
{
    difference()
    {
        ...
        color ("red") 
        {
            union () 
            {
                ...
                cube ([round_pump_outward_tensioner_thickness, round_pump_outward_tensioner_length, round_pump_outward_tensioner_height-(round_pump_raised_diameter/2)]) ;

                //RAISED WINGS
                for (i = [0 : round_pump_number_of_raised_wings-1]) // two iterations, z = -1, z = 1
                {
    ...
    //INWARD TENSIONER
    translate ([-round_pump_inward_tensioner_thickness/2,0,-round_pump_inward_tensioner_height+round_pump_diameter/2-(round_pump_diameter/2-round_pump_tip_hole_diameter/2)/2])
                cube ([round_pump_inward_tensioner_thickness, 
                       round_pump_inward_tensioner_length, 
                       round_pump_inward_tensioner_height]) ;
    
}
//END OF MODULE ROUND PUMP

module round_stl(round_stl_name=round_stl_name,
                    round_stl_tx=round_stl_tx,
                    round_stl_ty=round_stl_ty,
                    round_stl_tz=round_stl_tz,
                    round_stl_rx=round_stl_rx,
                    round_stl_ry=round_stl_ry,
                    round_stl_rz=round_stl_rz)
{
    translate([round_stl_tx, round_stl_ty, round_stl_tz]) 
    rotate([round_stl_rx, round_stl_ry, round_stl_rz])
    import(round_stl_name); 
}
//END OF MODULE ROUND STL
                          ...
                          lever_simple_blade_thickness=lever_simple_blade_thickness)
{
    color ("blue") 
    {
        ...
        cube([lever_simple_blade_thickness,lever_simple_blade_length,lever_simple_blade_height]) ;
    } 
}
//
...
//END OF MODULE LEVER SIMPLE COMPLETE


//BEGINNING OF SEVERAL MODULES FOR LEVER DOUBLE
...
//END OF MODULE LEVER DOUBLE COMPLETE
                        ...
                        abloy_classic_stl_name =  abloy_classic_stl_name)
{
    ...
    color ("red") 
    {
        ...
        {  
            ...
            resize([abloy_classic_thickness,abloy_classic_length+1,abloy_classic_height])
            rotate([-90,0,0])
            linear_extrude(height = abloy_classic_length+1, center = 1, convexity = 10)
            import (file = abloy_classic_dxf_name); 
        }//END OF ELSE  
    }// END OF COLOR 
    
}
//END OF MODULE ABLOY CLASSIC
...
module axi_home()
{
    ...
    if (axi_home_model=="LEFT")
        ...
        {
        cylinder(h = 5, d=10, center = true);
        cylinder(h = 6, d1 = 10, d2 = 0.2, center = true, $fn=100);
        } 
    }  
}
//END OF MODULE AXI HOME
...
//END OF MODULE FICHET 787




module expert_stl(  expert_stl_name =           "",
                    expert_stl_set_dimensions = "YES",
                    expert_stl_dx =             0,
                    expert_stl_dy =             0,
                    expert_stl_dz =             0,
...
//END OF MODULE EXPERT STL


//BLANK GENERATION BASED ON MODULES AND PARAMETERS
...
if (type_of_key == "dimple_laser")
    dimple_laser(
        dimple_laser_length,
        dimple_laser_width,
        dimple_laser_thickness,
        dimple_laser_dxf_name,
        dimple_laser_stl_name);
...
if (type_of_key == "round_pump")
    round_pump(
        round_pump_length,
        round_pump_diameter,
        round_pump_number_of_raised_wings,
        round_pump_raised_diameter,
        round_pump_raised_length_from_tip,
        round_pump_raised_thickness,
...
if (type_of_key == "axi_home")
    axi_home(axi_home_model);
...
/*cut(cut_to_use = "laser_cut",
    ...
    cone_height=10, 
    cone_bottom_diameter=1, 
    cone_angle=110, 
    cone_number_of_faces=20,

    laser_mill_height=10,
    laser_mill_diameter=2,
    laser_mill_number_of_faces=10,
    laser_mill_center="NO");
*/
...
//END OF MODULE PUMP CUT


module lever_cut_row1(   lever_lock_row1_number_of_levers = 		lever_lock_row1_number_of_levers,
                    lever_lock_row1_blade_length = 			lever_lock_row1_blade_length,
                    lever_lock_row1_spaces = 				lever_lock_row1_spaces,
                    lever_lock_row1_thickness = 			lever_lock_row1_thickness,
                    lever_lock_row1_angle_on_y = 			lever_lock_row1_angle_on_y)
{
    translate([0,lever_lock_row1_cut01_distance,lever_lock_row1_cut01_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut01_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut02_distance,lever_lock_row1_cut02_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut02_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut03_distance,lever_lock_row1_cut03_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut03_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut04_distance,lever_lock_row1_cut04_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut04_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut05_distance,lever_lock_row1_cut05_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut05_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut06_distance,lever_lock_row1_cut06_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut06_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut07_distance,lever_lock_row1_cut07_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut07_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut08_distance,lever_lock_row1_cut08_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut08_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut09_distance,lever_lock_row1_cut09_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut09_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut10_distance,lever_lock_row1_cut10_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut10_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut11_distance,lever_lock_row1_cut11_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut11_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut12_distance,lever_lock_row1_cut12_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut12_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut13_distance,lever_lock_row1_cut13_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut13_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut14_distance,lever_lock_row1_cut14_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut14_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut15_distance,lever_lock_row1_cut15_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut15_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut16_distance,lever_lock_row1_cut16_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut16_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut17_distance,lever_lock_row1_cut17_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut17_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut18_distance,lever_lock_row1_cut18_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut18_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut19_distance,lever_lock_row1_cut19_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut19_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row1_cut20_distance,lever_lock_row1_cut20_depth])
    rotate([0,lever_lock_row1_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row1_cut20_thickness,lever_cut_z], center=true);
    
    
}
//END OF MODULE LEVER CUT ROW 1

module lever_cut_row2(   lever_lock_row2_number_of_levers = 		lever_lock_row2_number_of_levers,
                    lever_lock_row2_blade_length = 			lever_lock_row2_blade_length,
                    lever_lock_row2_spaces = 				lever_lock_row2_spaces,
                    lever_lock_row2_thickness = 			lever_lock_row2_thickness,
                    lever_lock_row2_angle_on_y = 			lever_lock_row2_angle_on_y)
{
    mirror([0,0,1])
    {
    translate([0,lever_lock_row2_cut01_distance,lever_lock_row2_cut01_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut01_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut02_distance,lever_lock_row2_cut02_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut02_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut03_distance,lever_lock_row2_cut03_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut03_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut04_distance,lever_lock_row2_cut04_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut04_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut05_distance,lever_lock_row2_cut05_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut05_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut06_distance,lever_lock_row2_cut06_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut06_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut07_distance,lever_lock_row2_cut07_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut07_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut08_distance,lever_lock_row2_cut08_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut08_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut09_distance,lever_lock_row2_cut09_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut09_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut10_distance,lever_lock_row2_cut10_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut10_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut11_distance,lever_lock_row2_cut11_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut11_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut12_distance,lever_lock_row2_cut12_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut12_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut13_distance,lever_lock_row2_cut13_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut13_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut14_distance,lever_lock_row2_cut14_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut14_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut15_distance,lever_lock_row2_cut15_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut15_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut16_distance,lever_lock_row2_cut16_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut16_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut17_distance,lever_lock_row2_cut17_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut17_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut18_distance,lever_lock_row2_cut18_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut18_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut19_distance,lever_lock_row2_cut19_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut19_thickness,lever_cut_z], center=true);
    
    translate([0,lever_lock_row2_cut20_distance,lever_lock_row2_cut20_depth])
    rotate([0,lever_lock_row2_angle_on_y,0])
    translate([0,0,lever_cut_z/2])
    cube([lever_cut_x,lever_lock_row2_cut20_thickness,lever_cut_z], center=true);
    }//END OF MIRROR
    
}
//END OF MODULE LEVER CUT ROW 2
...
//END OF MODULE ABLOY CLASSIC COMPLETE CUT RIGHT
...
//END OF MODULE ABLOY CLASSIC COMPLETE CUT LEFT
...
//END OF MODULE ABLOY CLASSIC CUT COMPLETE
                            ...
                            abloy_disklock_groove_at_the_tip = abloy_disklock_groove_at_the_tip)
{
    ...
    {
        //CUT01
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(01-1)),0])
        abloy_disklock_mill(abloy_disklock_cut01);
    
        //CUT02
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(02-1)),0])
        abloy_disklock_mill(abloy_disklock_cut02);
    
        //CUT03
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(03-1)),0])
        abloy_disklock_mill(abloy_disklock_cut03);

        //CUT04
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(04-1)),0])
        abloy_disklock_mill(abloy_disklock_cut04);

        //CUT05
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(05-1)),0])
        abloy_disklock_mill(abloy_disklock_cut05);

        //CUT06
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(06-1)),0])
        abloy_disklock_mill(abloy_disklock_cut06);

        //CUT07
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(07-1)),0])
        abloy_disklock_mill(abloy_disklock_cut07);

        //CUT08
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(08-1)),0])
        abloy_disklock_mill(abloy_disklock_cut08);

        //CUT09
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(09-1)),0])
        abloy_disklock_mill(abloy_disklock_cut09);
        
        //CUT10
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(10-1)),0])
        abloy_disklock_mill(abloy_disklock_cut10);

        //CUT11
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(11-1)),0])
        abloy_disklock_mill(abloy_disklock_cut11);

        //CUT12
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(12-1)),0])
        abloy_disklock_mill(abloy_disklock_cut12);

        //CUT13
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(13-1)),0])
        abloy_disklock_mill(abloy_disklock_cut13);

        //CUT14
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(14-1)),0])
        abloy_disklock_mill(abloy_disklock_cut14);

        //CUT15
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(15-1)),0])
        abloy_disklock_mill(abloy_disklock_cut15);

        //CUT16
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(16-1)),0])
        abloy_disklock_mill(abloy_disklock_cut16);

        //CUT17
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(17-1)),0])
        abloy_disklock_mill(abloy_disklock_cut17);

        //CUT18
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(18-1)),0])
        abloy_disklock_mill(abloy_disklock_cut18);

        //CUT19
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(19-1)),0])
        abloy_disklock_mill(abloy_disklock_cut19);

        //CUT20
        translate ([0,abloy_disklock_length-abloy_disklock_distance_from_tip-(abloy_disklock_spaces*(20-1)),0])
...
//BEGINNING OF MODULES FOR AXI HOME

module axi_home_mill()
{
prism_cut(
    prism_root_x=axi_home_root_x, 
    prism_root_y=axi_home_root_y,
    prism_angle_x=90,
    prism_angle_y=90,
    prism_height=10);
}

module axi_home_row1()
{
	translate ([0,axi_home_row1_shoulder_distance,-axi_home_row1_cut01])
	axi_home_mill();
    
    translate ([0,axi_home_row1_shoulder_distance+(2-1)*axi_home_interpin_distance,-axi_home_row1_cut02])
	axi_home_mill();
    
    translate ([0,axi_home_row1_shoulder_distance+(3-1)*axi_home_interpin_distance,-axi_home_row1_cut03])
	axi_home_mill();

	translate ([0,axi_home_row1_shoulder_distance+(4-1)*axi_home_interpin_distance,-axi_home_row1_cut04])
	axi_home_mill();
	
    translate ([0,axi_home_row1_shoulder_distance+(5-1)*axi_home_interpin_distance,-axi_home_row1_cut05])
	axi_home_mill();
    
    translate ([0,axi_home_row1_shoulder_distance+(6-1)*axi_home_interpin_distance,-axi_home_row1_cut06])
	axi_home_mill();
}

module axi_home_row2()
{
	translate ([0,axi_home_row2_shoulder_distance,-axi_home_row2_cut01])
	axi_home_mill();
    
    translate ([0,axi_home_row2_shoulder_distance+(2-1)*axi_home_interpin_distance,-axi_home_row2_cut02])
	axi_home_mill();
    
    translate ([0,axi_home_row2_shoulder_distance+(3-1)*axi_home_interpin_distance,-axi_home_row2_cut03])
	axi_home_mill();

	translate ([0,axi_home_row2_shoulder_distance+(4-1)*axi_home_interpin_distance,-axi_home_row2_cut04])
	axi_home_mill();
	
    translate ([0,axi_home_row2_shoulder_distance+(5-1)*axi_home_interpin_distance,-axi_home_row2_cut05])
	axi_home_mill();
    
    translate ([0,axi_home_row2_shoulder_distance+(6-1)*axi_home_interpin_distance,-axi_home_row2_cut06])
	axi_home_mill();
}

module axi_home_row3()
{
	translate ([0,axi_home_row3_shoulder_distance,-axi_home_row3_cut01])
	axi_home_mill();
    
    translate ([0,axi_home_row3_shoulder_distance+(2-1)*axi_home_interpin_distance,-axi_home_row3_cut02])
	axi_home_mill();
    
    translate ([0,axi_home_row3_shoulder_distance+(3-1)*axi_home_interpin_distance,-axi_home_row3_cut03])
	axi_home_mill();

	translate ([0,axi_home_row3_shoulder_distance+(4-1)*axi_home_interpin_distance,-axi_home_row3_cut04])
	axi_home_mill();
	
    translate ([0,axi_home_row3_shoulder_distance+(5-1)*axi_home_interpin_distance,-axi_home_row3_cut05])
	axi_home_mill();
    
    translate ([0,axi_home_row3_shoulder_distance+(6-1)*axi_home_interpin_distance,-axi_home_row3_cut06])
	axi_home_mill();
}

module axi_home_top_row_cut(axi_home_top_row=axi_home_top_row)
{
	translate ([axi_home_top_row_x_offset,0,axi_home_key_thickness])
    {
        if (axi_home_top_row=="ROW1")
            axi_home_row1();
            
        if (axi_home_top_row=="ROW2")
            axi_home_row2();
            
        if (axi_home_top_row=="ROW3")
            axi_home_row3();
    }
}

module axi_home_right_row_cut(axi_home_right_row=axi_home_right_row)
{
    translate([2.5,0,3])
    rotate ([0,120,0])
    translate ([0,0,5/2])
    {
        ...
        if (axi_home_right_row=="ROW1")
            axi_home_row1();
            
        if (axi_home_right_row=="ROW2")
            axi_home_row2();
            
        if (axi_home_right_row=="ROW3")
            axi_home_row3();
    }
}

module axi_home_left_row_cut(axi_home_left_row=axi_home_left_row)
{
    ...
    translate ([0,0,5/2])
    {
        if (axi_home_left_row=="ROW1")
            axi_home_row1();
            
        if (axi_home_left_row=="ROW2")
            axi_home_row2();
            
        if (axi_home_left_row=="ROW3")
            axi_home_row3();
    }
}

module axi_home_complete_cut()
{
    axi_home_top_row_cut();
    axi_home_right_row_cut();
    axi_home_left_row_cut();
}
//END OF MODULE AXI HOME COMPLETE CUT
...
//BEGINNING OF MODULES FOR THE 10 SHAPES
module extra_cut_shape_01()
{

    if (extra_cut_shape_01_model=="CUBE")
    {
        if(extra_cut_shape_01_cube_centered=="YES")
        {
            translate(extra_cut_shape_01_cube_translate)
            rotate(extra_cut_shape_01_cube_rotation)
            cube(extra_cut_shape_01_cube_dimensions, center=true);
        }
        
        if(extra_cut_shape_01_cube_centered=="NO")
        {
            translate(extra_cut_shape_01_cube_translate)
            rotate(extra_cut_shape_01_cube_rotation)
            cube(extra_cut_shape_01_cube_dimensions, center=false);
        }


    }

    if (extra_cut_shape_01_model=="CYLINDER")
    {
        if(extra_cut_shape_01_cylinder_centered=="YES")
        {
            translate(extra_cut_shape_01_cylinder_translate)
            rotate(extra_cut_shape_01_cylinder_rotation)
            cylinder(d=extra_cut_shape_01_cylinder_diameter, h=extra_cut_shape_01_cylinder_height, $fn=extra_cut_shape_01_cylinder_number_of_faces, center=true);
        }
        
        if(extra_cut_shape_01_cylinder_centered=="NO")
        {
            translate(extra_cut_shape_01_cylinder_translate)
            rotate(extra_cut_shape_01_cylinder_rotation)
            cylinder(d=extra_cut_shape_01_cylinder_diameter, h=extra_cut_shape_01_cylinder_height, $fn=extra_cut_shape_01_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_cut_shape_01_model=="SPHERE")
    {
        translate(extra_cut_shape_01_sphere_translate)
        sphere(d=extra_cut_shape_01_sphere_diameter, $fn=extra_cut_shape_01_sphere_number_of_faces);	
    }

    if (extra_cut_shape_01_model=="STL")
    {
...
//END OF MODULE SHAPE 01

module extra_cut_shape_02()
{

    if (extra_cut_shape_02_model=="CUBE")
    {
        if(extra_cut_shape_02_cube_centered=="YES")
        {
            translate(extra_cut_shape_02_cube_translate)
            rotate(extra_cut_shape_02_cube_rotation)
            cube(extra_cut_shape_02_cube_dimensions, center=true);
        }
        
        if(extra_cut_shape_02_cube_centered=="NO")
        {
            translate(extra_cut_shape_02_cube_translate)
            rotate(extra_cut_shape_02_cube_rotation)
            cube(extra_cut_shape_02_cube_dimensions, center=false);
        }


    }

    if (extra_cut_shape_02_model=="CYLINDER")
    {
        if(extra_cut_shape_02_cylinder_centered=="YES")
        {
            translate(extra_cut_shape_02_cylinder_translate)
            rotate(extra_cut_shape_02_cylinder_rotation)
            cylinder(d=extra_cut_shape_02_cylinder_diameter, h=extra_cut_shape_02_cylinder_height, $fn=extra_cut_shape_02_cylinder_number_of_faces, center=true);
        }
        
        if(extra_cut_shape_02_cylinder_centered=="NO")
        {
            translate(extra_cut_shape_02_cylinder_translate)
            rotate(extra_cut_shape_02_cylinder_rotation)
            cylinder(d=extra_cut_shape_02_cylinder_diameter, h=extra_cut_shape_02_cylinder_height, $fn=extra_cut_shape_02_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_cut_shape_02_model=="SPHERE")
    {
        translate(extra_cut_shape_02_sphere_translate)
        sphere(d=extra_cut_shape_02_sphere_diameter, $fn=extra_cut_shape_02_sphere_number_of_faces);	
    }

    if (extra_cut_shape_02_model=="STL")
    {
...
//END OF MODULE SHAPE 02

module extra_cut_shape_03()
{

    if (extra_cut_shape_03_model=="CUBE")
    {
        if(extra_cut_shape_03_cube_centered=="YES")
        {
            translate(extra_cut_shape_03_cube_translate)
            rotate(extra_cut_shape_03_cube_rotation)
            cube(extra_cut_shape_03_cube_dimensions, center=true);
        }
        
        if(extra_cut_shape_03_cube_centered=="NO")
        {
            translate(extra_cut_shape_03_cube_translate)
            rotate(extra_cut_shape_03_cube_rotation)
            cube(extra_cut_shape_03_cube_dimensions, center=false);
        }


    }

    if (extra_cut_shape_03_model=="CYLINDER")
    {
        if(extra_cut_shape_03_cylinder_centered=="YES")
        {
            translate(extra_cut_shape_03_cylinder_translate)
            rotate(extra_cut_shape_03_cylinder_rotation)
            cylinder(d=extra_cut_shape_03_cylinder_diameter, h=extra_cut_shape_03_cylinder_height, $fn=extra_cut_shape_03_cylinder_number_of_faces, center=true);
        }
        
        if(extra_cut_shape_03_cylinder_centered=="NO")
        {
            translate(extra_cut_shape_03_cylinder_translate)
            rotate(extra_cut_shape_03_cylinder_rotation)
            cylinder(d=extra_cut_shape_03_cylinder_diameter, h=extra_cut_shape_03_cylinder_height, $fn=extra_cut_shape_03_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_cut_shape_03_model=="SPHERE")
    {
        translate(extra_cut_shape_03_sphere_translate)
        sphere(d=extra_cut_shape_03_sphere_diameter, $fn=extra_cut_shape_03_sphere_number_of_faces);	
    }

    if (extra_cut_shape_03_model=="STL")
    {
...
//END OF MODULE SHAPE 03


module extra_cut_shape_04()
{

    if (extra_cut_shape_04_model=="CUBE")
    {
        if(extra_cut_shape_04_cube_centered=="YES")
        {
            translate(extra_cut_shape_04_cube_translate)
            rotate(extra_cut_shape_04_cube_rotation)
            cube(extra_cut_shape_04_cube_dimensions, center=true);
        }
        
        if(extra_cut_shape_04_cube_centered=="NO")
        {
            translate(extra_cut_shape_04_cube_translate)
            rotate(extra_cut_shape_04_cube_rotation)
            cube(extra_cut_shape_04_cube_dimensions, center=false);
        }


    }

    if (extra_cut_shape_04_model=="CYLINDER")
    {
        if(extra_cut_shape_04_cylinder_centered=="YES")
        {
            translate(extra_cut_shape_04_cylinder_translate)
            rotate(extra_cut_shape_04_cylinder_rotation)
            cylinder(d=extra_cut_shape_04_cylinder_diameter, h=extra_cut_shape_04_cylinder_height, $fn=extra_cut_shape_04_cylinder_number_of_faces, center=true);
        }
        
        if(extra_cut_shape_04_cylinder_centered=="NO")
        {
            translate(extra_cut_shape_04_cylinder_translate)
            rotate(extra_cut_shape_04_cylinder_rotation)
            cylinder(d=extra_cut_shape_04_cylinder_diameter, h=extra_cut_shape_04_cylinder_height, $fn=extra_cut_shape_04_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_cut_shape_04_model=="SPHERE")
    {
        translate(extra_cut_shape_04_sphere_translate)
        sphere(d=extra_cut_shape_04_sphere_diameter, $fn=extra_cut_shape_04_sphere_number_of_faces);	
    }

    if (extra_cut_shape_04_model=="STL")
    {
...
//END OF MODULE SHAPE 04


module extra_cut_shape_05()
{

    if (extra_cut_shape_05_model=="CUBE")
    {
        if(extra_cut_shape_05_cube_centered=="YES")
        {
            translate(extra_cut_shape_05_cube_translate)
            rotate(extra_cut_shape_05_cube_rotation)
            cube(extra_cut_shape_05_cube_dimensions, center=true);
        }
        
        if(extra_cut_shape_05_cube_centered=="NO")
        {
            translate(extra_cut_shape_05_cube_translate)
            rotate(extra_cut_shape_05_cube_rotation)
            cube(extra_cut_shape_05_cube_dimensions, center=false);
        }


    }

    if (extra_cut_shape_05_model=="CYLINDER")
    {
        if(extra_cut_shape_05_cylinder_centered=="YES")
        {
            translate(extra_cut_shape_05_cylinder_translate)
            rotate(extra_cut_shape_05_cylinder_rotation)
            cylinder(d=extra_cut_shape_05_cylinder_diameter, h=extra_cut_shape_05_cylinder_height, $fn=extra_cut_shape_05_cylinder_number_of_faces, center=true);
        }
        
        if(extra_cut_shape_05_cylinder_centered=="NO")
        {
            translate(extra_cut_shape_05_cylinder_translate)
            rotate(extra_cut_shape_05_cylinder_rotation)
            cylinder(d=extra_cut_shape_05_cylinder_diameter, h=extra_cut_shape_05_cylinder_height, $fn=extra_cut_shape_05_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_cut_shape_05_model=="SPHERE")
    {
        translate(extra_cut_shape_05_sphere_translate)
        sphere(d=extra_cut_shape_05_sphere_diameter, $fn=extra_cut_shape_05_sphere_number_of_faces);	
    }

    if (extra_cut_shape_05_model=="STL")
    {
...
//END OF MODULE SHAPE 05


module extra_cut_shape_06()
{

    if (extra_cut_shape_06_model=="CUBE")
    {
        if(extra_cut_shape_06_cube_centered=="YES")
        {
            translate(extra_cut_shape_06_cube_translate)
            rotate(extra_cut_shape_06_cube_rotation)
            cube(extra_cut_shape_06_cube_dimensions, center=true);
        }
        
        if(extra_cut_shape_06_cube_centered=="NO")
        {
            translate(extra_cut_shape_06_cube_translate)
            rotate(extra_cut_shape_06_cube_rotation)
            cube(extra_cut_shape_06_cube_dimensions, center=false);
        }


    }

    if (extra_cut_shape_06_model=="CYLINDER")
    {
        if(extra_cut_shape_06_cylinder_centered=="YES")
        {
            translate(extra_cut_shape_06_cylinder_translate)
            rotate(extra_cut_shape_06_cylinder_rotation)
            cylinder(d=extra_cut_shape_06_cylinder_diameter, h=extra_cut_shape_06_cylinder_height, $fn=extra_cut_shape_06_cylinder_number_of_faces, center=true);
        }
        
        if(extra_cut_shape_06_cylinder_centered=="NO")
        {
            translate(extra_cut_shape_06_cylinder_translate)
            rotate(extra_cut_shape_06_cylinder_rotation)
            cylinder(d=extra_cut_shape_06_cylinder_diameter, h=extra_cut_shape_06_cylinder_height, $fn=extra_cut_shape_06_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_cut_shape_06_model=="SPHERE")
    {
        translate(extra_cut_shape_06_sphere_translate)
        sphere(d=extra_cut_shape_06_sphere_diameter, $fn=extra_cut_shape_06_sphere_number_of_faces);	
    }

    if (extra_cut_shape_06_model=="STL")
    {
...
//END OF MODULE SHAPE 06


module extra_cut_shape_07()
{

    if (extra_cut_shape_07_model=="CUBE")
    {
        if(extra_cut_shape_07_cube_centered=="YES")
        {
            translate(extra_cut_shape_07_cube_translate)
            rotate(extra_cut_shape_07_cube_rotation)
            cube(extra_cut_shape_07_cube_dimensions, center=true);
        }
        
        if(extra_cut_shape_07_cube_centered=="NO")
        {
            translate(extra_cut_shape_07_cube_translate)
            rotate(extra_cut_shape_07_cube_rotation)
            cube(extra_cut_shape_07_cube_dimensions, center=false);
        }


    }

    if (extra_cut_shape_07_model=="CYLINDER")
    {
        if(extra_cut_shape_07_cylinder_centered=="YES")
        {
            translate(extra_cut_shape_07_cylinder_translate)
            rotate(extra_cut_shape_07_cylinder_rotation)
            cylinder(d=extra_cut_shape_07_cylinder_diameter, h=extra_cut_shape_07_cylinder_height, $fn=extra_cut_shape_07_cylinder_number_of_faces, center=true);
        }
        
        if(extra_cut_shape_07_cylinder_centered=="NO")
        {
            translate(extra_cut_shape_07_cylinder_translate)
            rotate(extra_cut_shape_07_cylinder_rotation)
            cylinder(d=extra_cut_shape_07_cylinder_diameter, h=extra_cut_shape_07_cylinder_height, $fn=extra_cut_shape_07_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_cut_shape_07_model=="SPHERE")
    {
        translate(extra_cut_shape_07_sphere_translate)
        sphere(d=extra_cut_shape_07_sphere_diameter, $fn=extra_cut_shape_07_sphere_number_of_faces);	
    }

    if (extra_cut_shape_07_model=="STL")
    {
...
//END OF MODULE SHAPE 07


module extra_cut_shape_08()
{

    if (extra_cut_shape_08_model=="CUBE")
    {
        if(extra_cut_shape_08_cube_centered=="YES")
        {
            translate(extra_cut_shape_08_cube_translate)
            rotate(extra_cut_shape_08_cube_rotation)
            cube(extra_cut_shape_08_cube_dimensions, center=true);
        }
        
        if(extra_cut_shape_08_cube_centered=="NO")
        {
            translate(extra_cut_shape_08_cube_translate)
            rotate(extra_cut_shape_08_cube_rotation)
            cube(extra_cut_shape_08_cube_dimensions, center=false);
        }


    }

    if (extra_cut_shape_08_model=="CYLINDER")
    {
        if(extra_cut_shape_08_cylinder_centered=="YES")
        {
            translate(extra_cut_shape_08_cylinder_translate)
            rotate(extra_cut_shape_08_cylinder_rotation)
            cylinder(d=extra_cut_shape_08_cylinder_diameter, h=extra_cut_shape_08_cylinder_height, $fn=extra_cut_shape_08_cylinder_number_of_faces, center=true);
        }
        
        if(extra_cut_shape_08_cylinder_centered=="NO")
        {
            translate(extra_cut_shape_08_cylinder_translate)
            rotate(extra_cut_shape_08_cylinder_rotation)
            cylinder(d=extra_cut_shape_08_cylinder_diameter, h=extra_cut_shape_08_cylinder_height, $fn=extra_cut_shape_08_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_cut_shape_08_model=="SPHERE")
    {
        translate(extra_cut_shape_08_sphere_translate)
        sphere(d=extra_cut_shape_08_sphere_diameter, $fn=extra_cut_shape_08_sphere_number_of_faces);	
    }

    if (extra_cut_shape_08_model=="STL")
    {
...
//END OF MODULE SHAPE 08


module extra_cut_shape_09()
{

    if (extra_cut_shape_09_model=="CUBE")
    {
        if(extra_cut_shape_09_cube_centered=="YES")
        {
            translate(extra_cut_shape_09_cube_translate)
            rotate(extra_cut_shape_09_cube_rotation)
            cube(extra_cut_shape_09_cube_dimensions, center=true);
        }
        
        if(extra_cut_shape_09_cube_centered=="NO")
        {
            translate(extra_cut_shape_09_cube_translate)
            rotate(extra_cut_shape_09_cube_rotation)
            cube(extra_cut_shape_09_cube_dimensions, center=false);
        }


    }

    if (extra_cut_shape_09_model=="CYLINDER")
    {
        if(extra_cut_shape_09_cylinder_centered=="YES")
        {
            translate(extra_cut_shape_09_cylinder_translate)
            rotate(extra_cut_shape_09_cylinder_rotation)
            cylinder(d=extra_cut_shape_09_cylinder_diameter, h=extra_cut_shape_09_cylinder_height, $fn=extra_cut_shape_09_cylinder_number_of_faces, center=true);
        }
        
        if(extra_cut_shape_09_cylinder_centered=="NO")
        {
            translate(extra_cut_shape_09_cylinder_translate)
            rotate(extra_cut_shape_09_cylinder_rotation)
            cylinder(d=extra_cut_shape_09_cylinder_diameter, h=extra_cut_shape_09_cylinder_height, $fn=extra_cut_shape_09_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_cut_shape_09_model=="SPHERE")
    {
        translate(extra_cut_shape_09_sphere_translate)
        sphere(d=extra_cut_shape_09_sphere_diameter, $fn=extra_cut_shape_09_sphere_number_of_faces);	
    }

    if (extra_cut_shape_09_model=="STL")
    {
...
//END OF MODULE SHAPE 09


module extra_cut_shape_10()
{

    if (extra_cut_shape_10_model=="CUBE")
    {
        if(extra_cut_shape_10_cube_centered=="YES")
        {
            translate(extra_cut_shape_10_cube_translate)
            rotate(extra_cut_shape_10_cube_rotation)
            cube(extra_cut_shape_10_cube_dimensions, center=true);
        }
        
        if(extra_cut_shape_10_cube_centered=="NO")
        {
            translate(extra_cut_shape_10_cube_translate)
            rotate(extra_cut_shape_10_cube_rotation)
            cube(extra_cut_shape_10_cube_dimensions, center=false);
        }


    }

    if (extra_cut_shape_10_model=="CYLINDER")
    {
        if(extra_cut_shape_10_cylinder_centered=="YES")
        {
            translate(extra_cut_shape_10_cylinder_translate)
            rotate(extra_cut_shape_10_cylinder_rotation)
            cylinder(d=extra_cut_shape_10_cylinder_diameter, h=extra_cut_shape_10_cylinder_height, $fn=extra_cut_shape_10_cylinder_number_of_faces, center=true);
        }
        
        if(extra_cut_shape_10_cylinder_centered=="NO")
        {
            translate(extra_cut_shape_10_cylinder_translate)
            rotate(extra_cut_shape_10_cylinder_rotation)
            cylinder(d=extra_cut_shape_10_cylinder_diameter, h=extra_cut_shape_10_cylinder_height, $fn=extra_cut_shape_10_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_cut_shape_10_model=="SPHERE")
    {
        translate(extra_cut_shape_10_sphere_translate)
        sphere(d=extra_cut_shape_10_sphere_diameter, $fn=extra_cut_shape_10_sphere_number_of_faces);	
    }

    if (extra_cut_shape_10_model=="STL")
    {
...
//END OF MODULE SHAPE 10

//BEGINNING OF MODULE PERFORMING THE CUTS IF CHOSEN
module perform_chosen_cuts()
{
    ...
    if(lever_lock_cut_use == "YES")  
    {    
        if(lever_lock_row1_cut_use == "YES") lever_cut_row1();
        if(lever_lock_row2_cut_use == "YES") lever_cut_row2();
    ...
    if(axi_home_cut_use == "YES")            axi_home_complete_cut();
    if(fichet_787_cut_use == "YES")          fichet_787_cut();
        
    if(extra_cut_use == "YES")   
    {    
        if(extra_cut_shape01_use == "YES")   extra_cut_shape_01();
        if(extra_cut_shape02_use == "YES")   extra_cut_shape_02();
        if(extra_cut_shape03_use == "YES")   extra_cut_shape_03();
        if(extra_cut_shape04_use == "YES")   extra_cut_shape_04();
        if(extra_cut_shape05_use == "YES")   extra_cut_shape_05();
        if(extra_cut_shape06_use == "YES")   extra_cut_shape_06();
        if(extra_cut_shape07_use == "YES")   extra_cut_shape_07();
        if(extra_cut_shape08_use == "YES")   extra_cut_shape_08();
        if(extra_cut_shape09_use == "YES")   extra_cut_shape_09();
        if(extra_cut_shape10_use == "YES")   extra_cut_shape_10();
    } 
}
//END OF MODULE PERFORM CHOSEN CUTS

//MODULES FOR KEY HEAD/SHOULDER AND ADDITION MATERIAL
module ofc_branding()
{
...
module automatic_key_head_and_shoulder()
{
    ...
    if (automatic_key_head_and_shoulder=="YES")
    {
        ...
        if (type_of_key == "dimple_laser")
        {
            ...
            {
                //DIMPLE SHOULDER
                translate ([dimple_laser_width/2,-1.5,dimple_laser_thickness/2])
                cube([11,3,dimple_laser_thickness+0.05],center = true) ;

                //DIMPLE KEY HEAD
                translate ([dimple_laser_width/2,-13,dimple_laser_thickness/2])
                cube([20,20,dimple_laser_thickness+1],center = true) ; 
            }
        }
        ...
        if (type_of_key == "axi_home")
        {
            ...
            {
                //AXI HOME SHOULDER
                translate([5.66/2,0,5.24/2])
                rotate([90,0,0])
                cylinder(h = 18, d=7, center = false, $fn=100);


                //AXI HOME KEY HEAD
                translate([0.3,-14.8,6])
                rotate([0,90,0])

                translate ([axi_home_key_width/2,-13,axi_home_key_thickness/2])
...
//BEGINNING OF MODULES FOR ADDING THE 10 SHAPES
module extra_material_shape_01()
{

    if (extra_material_shape_01_model=="CUBE")
    {
        if(extra_material_shape_01_cube_centered=="YES")
        {
            translate(extra_material_shape_01_cube_translate)
            rotate(extra_material_shape_01_cube_rotation)
            cube(extra_material_shape_01_cube_dimensions, center=true);
        }
        
        if(extra_material_shape_01_cube_centered=="NO")
        {
            translate(extra_material_shape_01_cube_translate)
            rotate(extra_material_shape_01_cube_rotation)
            cube(extra_material_shape_01_cube_dimensions, center=false);
        }


    }

    if (extra_material_shape_01_model=="CYLINDER")
    {
        if(extra_material_shape_01_cylinder_centered=="YES")
        {
            translate(extra_material_shape_01_cylinder_translate)
            rotate(extra_material_shape_01_cylinder_rotation)
            cylinder(d=extra_material_shape_01_cylinder_diameter, h=extra_material_shape_01_cylinder_height, $fn=extra_material_shape_01_cylinder_number_of_faces, center=true);
        }
        
        if(extra_material_shape_01_cylinder_centered=="NO")
        {
            translate(extra_material_shape_01_cylinder_translate)
            rotate(extra_material_shape_01_cylinder_rotation)
            cylinder(d=extra_material_shape_01_cylinder_diameter, h=extra_material_shape_01_cylinder_height, $fn=extra_material_shape_01_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_material_shape_01_model=="SPHERE")
    {
        translate(extra_material_shape_01_sphere_translate)
        sphere(d=extra_material_shape_01_sphere_diameter, $fn=extra_material_shape_01_sphere_number_of_faces);	
    }

    if (extra_material_shape_01_model=="STL")
    {
...
module extra_material_shape_02()
{

    if (extra_material_shape_02_model=="CUBE")
    {
        if(extra_material_shape_02_cube_centered=="YES")
        {
            translate(extra_material_shape_02_cube_translate)
            rotate(extra_material_shape_02_cube_rotation)
            cube(extra_material_shape_02_cube_dimensions, center=true);
        }
        
        if(extra_material_shape_02_cube_centered=="NO")
        {
            translate(extra_material_shape_02_cube_translate)
            rotate(extra_material_shape_02_cube_rotation)
            cube(extra_material_shape_02_cube_dimensions, center=false);
        }


    }

    if (extra_material_shape_02_model=="CYLINDER")
    {
        if(extra_material_shape_02_cylinder_centered=="YES")
        {
            translate(extra_material_shape_02_cylinder_translate)
            rotate(extra_material_shape_02_cylinder_rotation)
            cylinder(d=extra_material_shape_02_cylinder_diameter, h=extra_material_shape_02_cylinder_height, $fn=extra_material_shape_02_cylinder_number_of_faces, center=true);
        }
        
        if(extra_material_shape_02_cylinder_centered=="NO")
        {
            translate(extra_material_shape_02_cylinder_translate)
            rotate(extra_material_shape_02_cylinder_rotation)
            cylinder(d=extra_material_shape_02_cylinder_diameter, h=extra_material_shape_02_cylinder_height, $fn=extra_material_shape_02_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_material_shape_02_model=="SPHERE")
    {
        translate(extra_material_shape_02_sphere_translate)
        sphere(d=extra_material_shape_02_sphere_diameter, $fn=extra_material_shape_02_sphere_number_of_faces);	
    }

    if (extra_material_shape_02_model=="STL")
    {
...
module extra_material_shape_03()
{

    if (extra_material_shape_03_model=="CUBE")
    {
        if(extra_material_shape_03_cube_centered=="YES")
        {
            translate(extra_material_shape_03_cube_translate)
            rotate(extra_material_shape_03_cube_rotation)
            cube(extra_material_shape_03_cube_dimensions, center=true);
        }
        
        if(extra_material_shape_03_cube_centered=="NO")
        {
            translate(extra_material_shape_03_cube_translate)
            rotate(extra_material_shape_03_cube_rotation)
            cube(extra_material_shape_03_cube_dimensions, center=false);
        }


    }

    if (extra_material_shape_03_model=="CYLINDER")
    {
        if(extra_material_shape_03_cylinder_centered=="YES")
        {
            translate(extra_material_shape_03_cylinder_translate)
            rotate(extra_material_shape_03_cylinder_rotation)
            cylinder(d=extra_material_shape_03_cylinder_diameter, h=extra_material_shape_03_cylinder_height, $fn=extra_material_shape_03_cylinder_number_of_faces, center=true);
        }
        
        if(extra_material_shape_03_cylinder_centered=="NO")
        {
            translate(extra_material_shape_03_cylinder_translate)
            rotate(extra_material_shape_03_cylinder_rotation)
            cylinder(d=extra_material_shape_03_cylinder_diameter, h=extra_material_shape_03_cylinder_height, $fn=extra_material_shape_03_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_material_shape_03_model=="SPHERE")
    {
        translate(extra_material_shape_03_sphere_translate)
        sphere(d=extra_material_shape_03_sphere_diameter, $fn=extra_material_shape_03_sphere_number_of_faces);	
    }

    if (extra_material_shape_03_model=="STL")
    {
...
module extra_material_shape_04()
{

    if (extra_material_shape_04_model=="CUBE")
    {
        if(extra_material_shape_04_cube_centered=="YES")
        {
            translate(extra_material_shape_04_cube_translate)
            rotate(extra_material_shape_04_cube_rotation)
            cube(extra_material_shape_04_cube_dimensions, center=true);
        }
        
        if(extra_material_shape_04_cube_centered=="NO")
        {
            translate(extra_material_shape_04_cube_translate)
            rotate(extra_material_shape_04_cube_rotation)
            cube(extra_material_shape_04_cube_dimensions, center=false);
        }


    }

    if (extra_material_shape_04_model=="CYLINDER")
    {
        if(extra_material_shape_04_cylinder_centered=="YES")
        {
            translate(extra_material_shape_04_cylinder_translate)
            rotate(extra_material_shape_04_cylinder_rotation)
            cylinder(d=extra_material_shape_04_cylinder_diameter, h=extra_material_shape_04_cylinder_height, $fn=extra_material_shape_04_cylinder_number_of_faces, center=true);
        }
        
        if(extra_material_shape_04_cylinder_centered=="NO")
        {
            translate(extra_material_shape_04_cylinder_translate)
            rotate(extra_material_shape_04_cylinder_rotation)
            cylinder(d=extra_material_shape_04_cylinder_diameter, h=extra_material_shape_04_cylinder_height, $fn=extra_material_shape_04_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_material_shape_04_model=="SPHERE")
    {
        translate(extra_material_shape_04_sphere_translate)
        sphere(d=extra_material_shape_04_sphere_diameter, $fn=extra_material_shape_04_sphere_number_of_faces);	
    }

    if (extra_material_shape_04_model=="STL")
    {
...
module extra_material_shape_05()
{

    if (extra_material_shape_05_model=="CUBE")
    {
        if(extra_material_shape_05_cube_centered=="YES")
        {
            translate(extra_material_shape_05_cube_translate)
            rotate(extra_material_shape_05_cube_rotation)
            cube(extra_material_shape_05_cube_dimensions, center=true);
        }
        
        if(extra_material_shape_05_cube_centered=="NO")
        {
            translate(extra_material_shape_05_cube_translate)
            rotate(extra_material_shape_05_cube_rotation)
            cube(extra_material_shape_05_cube_dimensions, center=false);
        }


    }

    if (extra_material_shape_05_model=="CYLINDER")
    {
        if(extra_material_shape_05_cylinder_centered=="YES")
        {
            translate(extra_material_shape_05_cylinder_translate)
            rotate(extra_material_shape_05_cylinder_rotation)
            cylinder(d=extra_material_shape_05_cylinder_diameter, h=extra_material_shape_05_cylinder_height, $fn=extra_material_shape_05_cylinder_number_of_faces, center=true);
        }
        
        if(extra_material_shape_05_cylinder_centered=="NO")
        {
            translate(extra_material_shape_05_cylinder_translate)
            rotate(extra_material_shape_05_cylinder_rotation)
            cylinder(d=extra_material_shape_05_cylinder_diameter, h=extra_material_shape_05_cylinder_height, $fn=extra_material_shape_05_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_material_shape_05_model=="SPHERE")
    {
        translate(extra_material_shape_05_sphere_translate)
        sphere(d=extra_material_shape_05_sphere_diameter, $fn=extra_material_shape_05_sphere_number_of_faces);	
    }

    if (extra_material_shape_05_model=="STL")
    {
...
module extra_material_shape_06()
{

    if (extra_material_shape_06_model=="CUBE")
    {
        if(extra_material_shape_06_cube_centered=="YES")
        {
            translate(extra_material_shape_06_cube_translate)
            rotate(extra_material_shape_06_cube_rotation)
            cube(extra_material_shape_06_cube_dimensions, center=true);
        }
        
        if(extra_material_shape_06_cube_centered=="NO")
        {
            translate(extra_material_shape_06_cube_translate)
            rotate(extra_material_shape_06_cube_rotation)
            cube(extra_material_shape_06_cube_dimensions, center=false);
        }


    }

    if (extra_material_shape_06_model=="CYLINDER")
    {
        if(extra_material_shape_06_cylinder_centered=="YES")
        {
            translate(extra_material_shape_06_cylinder_translate)
            rotate(extra_material_shape_06_cylinder_rotation)
            cylinder(d=extra_material_shape_06_cylinder_diameter, h=extra_material_shape_06_cylinder_height, $fn=extra_material_shape_06_cylinder_number_of_faces, center=true);
        }
        
        if(extra_material_shape_06_cylinder_centered=="NO")
        {
            translate(extra_material_shape_06_cylinder_translate)
            rotate(extra_material_shape_06_cylinder_rotation)
            cylinder(d=extra_material_shape_06_cylinder_diameter, h=extra_material_shape_06_cylinder_height, $fn=extra_material_shape_06_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_material_shape_06_model=="SPHERE")
    {
        translate(extra_material_shape_06_sphere_translate)
        sphere(d=extra_material_shape_06_sphere_diameter, $fn=extra_material_shape_06_sphere_number_of_faces);	
    }

    if (extra_material_shape_06_model=="STL")
    {
...
module extra_material_shape_07()
{

    if (extra_material_shape_07_model=="CUBE")
    {
        if(extra_material_shape_07_cube_centered=="YES")
        {
            translate(extra_material_shape_07_cube_translate)
            rotate(extra_material_shape_07_cube_rotation)
            cube(extra_material_shape_07_cube_dimensions, center=true);
        }
        
        if(extra_material_shape_07_cube_centered=="NO")
        {
            translate(extra_material_shape_07_cube_translate)
            rotate(extra_material_shape_07_cube_rotation)
            cube(extra_material_shape_07_cube_dimensions, center=false);
        }


    }

    if (extra_material_shape_07_model=="CYLINDER")
    {
        if(extra_material_shape_07_cylinder_centered=="YES")
        {
            translate(extra_material_shape_07_cylinder_translate)
            rotate(extra_material_shape_07_cylinder_rotation)
            cylinder(d=extra_material_shape_07_cylinder_diameter, h=extra_material_shape_07_cylinder_height, $fn=extra_material_shape_07_cylinder_number_of_faces, center=true);
        }
        
        if(extra_material_shape_07_cylinder_centered=="NO")
        {
            translate(extra_material_shape_07_cylinder_translate)
            rotate(extra_material_shape_07_cylinder_rotation)
            cylinder(d=extra_material_shape_07_cylinder_diameter, h=extra_material_shape_07_cylinder_height, $fn=extra_material_shape_07_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_material_shape_07_model=="SPHERE")
    {
        translate(extra_material_shape_07_sphere_translate)
        sphere(d=extra_material_shape_07_sphere_diameter, $fn=extra_material_shape_07_sphere_number_of_faces);	
    }

    if (extra_material_shape_07_model=="STL")
    {
...
module extra_material_shape_08()
{

    if (extra_material_shape_08_model=="CUBE")
    {
        if(extra_material_shape_08_cube_centered=="YES")
        {
            translate(extra_material_shape_08_cube_translate)
            rotate(extra_material_shape_08_cube_rotation)
            cube(extra_material_shape_08_cube_dimensions, center=true);
        }
        
        if(extra_material_shape_08_cube_centered=="NO")
        {
            translate(extra_material_shape_08_cube_translate)
            rotate(extra_material_shape_08_cube_rotation)
            cube(extra_material_shape_08_cube_dimensions, center=false);
        }


    }

    if (extra_material_shape_08_model=="CYLINDER")
    {
        if(extra_material_shape_08_cylinder_centered=="YES")
        {
            translate(extra_material_shape_08_cylinder_translate)
            rotate(extra_material_shape_08_cylinder_rotation)
            cylinder(d=extra_material_shape_08_cylinder_diameter, h=extra_material_shape_08_cylinder_height, $fn=extra_material_shape_08_cylinder_number_of_faces, center=true);
        }
        
        if(extra_material_shape_08_cylinder_centered=="NO")
        {
            translate(extra_material_shape_08_cylinder_translate)
            rotate(extra_material_shape_08_cylinder_rotation)
            cylinder(d=extra_material_shape_08_cylinder_diameter, h=extra_material_shape_08_cylinder_height, $fn=extra_material_shape_08_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_material_shape_08_model=="SPHERE")
    {
        translate(extra_material_shape_08_sphere_translate)
        sphere(d=extra_material_shape_08_sphere_diameter, $fn=extra_material_shape_08_sphere_number_of_faces);	
    }

    if (extra_material_shape_08_model=="STL")
    {
...
module extra_material_shape_09()
{

    if (extra_material_shape_09_model=="CUBE")
    {
        if(extra_material_shape_09_cube_centered=="YES")
        {
            translate(extra_material_shape_09_cube_translate)
            rotate(extra_material_shape_09_cube_rotation)
            cube(extra_material_shape_09_cube_dimensions, center=true);
        }
        
        if(extra_material_shape_09_cube_centered=="NO")
        {
            translate(extra_material_shape_09_cube_translate)
            rotate(extra_material_shape_09_cube_rotation)
            cube(extra_material_shape_09_cube_dimensions, center=false);
        }


    }

    if (extra_material_shape_09_model=="CYLINDER")
    {
        if(extra_material_shape_09_cylinder_centered=="YES")
        {
            translate(extra_material_shape_09_cylinder_translate)
            rotate(extra_material_shape_09_cylinder_rotation)
            cylinder(d=extra_material_shape_09_cylinder_diameter, h=extra_material_shape_09_cylinder_height, $fn=extra_material_shape_09_cylinder_number_of_faces, center=true);
        }
        
        if(extra_material_shape_09_cylinder_centered=="NO")
        {
            translate(extra_material_shape_09_cylinder_translate)
            rotate(extra_material_shape_09_cylinder_rotation)
            cylinder(d=extra_material_shape_09_cylinder_diameter, h=extra_material_shape_09_cylinder_height, $fn=extra_material_shape_09_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_material_shape_09_model=="SPHERE")
    {
        translate(extra_material_shape_09_sphere_translate)
        sphere(d=extra_material_shape_09_sphere_diameter, $fn=extra_material_shape_09_sphere_number_of_faces);	
    }

    if (extra_material_shape_09_model=="STL")
    {
...
module extra_material_shape_10()
{

    if (extra_material_shape_10_model=="CUBE")
    {
        if(extra_material_shape_10_cube_centered=="YES")
        {
            translate(extra_material_shape_10_cube_translate)
            rotate(extra_material_shape_10_cube_rotation)
            cube(extra_material_shape_10_cube_dimensions, center=true);
        }
        
        if(extra_material_shape_10_cube_centered=="NO")
        {
            translate(extra_material_shape_10_cube_translate)
            rotate(extra_material_shape_10_cube_rotation)
            cube(extra_material_shape_10_cube_dimensions, center=false);
        }


    }

    if (extra_material_shape_10_model=="CYLINDER")
    {
        if(extra_material_shape_10_cylinder_centered=="YES")
        {
            translate(extra_material_shape_10_cylinder_translate)
            rotate(extra_material_shape_10_cylinder_rotation)
            cylinder(d=extra_material_shape_10_cylinder_diameter, h=extra_material_shape_10_cylinder_height, $fn=extra_material_shape_10_cylinder_number_of_faces, center=true);
        }
        
        if(extra_material_shape_10_cylinder_centered=="NO")
        {
            translate(extra_material_shape_10_cylinder_translate)
            rotate(extra_material_shape_10_cylinder_rotation)
            cylinder(d=extra_material_shape_10_cylinder_diameter, h=extra_material_shape_10_cylinder_height, $fn=extra_material_shape_10_cylinder_number_of_faces, center=false);
        }
    }

    if (extra_material_shape_10_model=="SPHERE")
    {
        translate(extra_material_shape_10_sphere_translate)
        sphere(d=extra_material_shape_10_sphere_diameter, $fn=extra_material_shape_10_sphere_number_of_faces);	
    }

    if (extra_material_shape_10_model=="STL")
    {
...
//END OF MODULE ADDING SHAPE 10

module extra_material_use()
{
    if(extra_material_use == "YES")   
    {    
        if(extra_material_shape01_use == "YES")   extra_material_shape_01();
        if(extra_material_shape02_use == "YES")   extra_material_shape_02();
        if(extra_material_shape03_use == "YES")   extra_material_shape_03();
        if(extra_material_shape04_use == "YES")   extra_material_shape_04();
        if(extra_material_shape05_use == "YES")   extra_material_shape_05();
        if(extra_material_shape06_use == "YES")   extra_material_shape_06();
        if(extra_material_shape07_use == "YES")   extra_material_shape_07();
        if(extra_material_shape08_use == "YES")   extra_material_shape_08();
        if(extra_material_shape09_use == "YES")   extra_material_shape_09();
        if(extra_material_shape10_use == "YES")   extra_material_shape_10();
    } 
    
    
}
//END OF MODULE ADDING CHOSEN SHAPES




//BLANK CREATION/ CUTTING/ ADDING MATERIAL
difference()
{
